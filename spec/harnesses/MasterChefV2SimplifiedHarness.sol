...
contract MasterChefV2SimplifiedHarness is MasterChefV2Harness {
    ...
    function calculateSushiReward(uint256 blocks, uint64 poolAllocPoint) override public returns (uint256) {
    ...
    function calculateSushiPerShare(uint256 sushiReward, uint256 lpSupply) override public returns (uint128) {
