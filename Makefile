...
hh-test:  ## help for job 1
	@echo "job 1 started"
	@$(MAKE) npx hardhat test --verbose --logs
	@echo "job 1 finished"

hh-debug:  ## help for job 2
	@echo "job 2"
...
help:
	@echo ""
	@echo "    ${BLACK}:: ${RED}HardHat Makefile${RESET} ${BLACK}::${RESET}"
	@echo ""
	@echo "Document targets by adding '$(POUND)$(POUND) comment' after the target"
	@echo ""
	@echo "Example:"
	@echo "  | hh-test:  $(POUND)$(POUND) help for hardhat test"
	@echo "  | 	@echo \"npx hardhat --flags target1\""
	@echo ""
	@echo "${BLACK}-----------------------------------------------------------------${RESET}"
